  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Random {region} Vacation Picker</h1>
        <p className="text-xl text-gray-600">Let our vacation destination generator find your perfect {region} getaway!</p>
      </div>
      ...
      <div className="flex justify-center mb-8">
        ...
        >
          ...
          <span>{isLoading ? 'Finding your perfect vacation...' : `Pick a Random ${region} Vacation`}</span>
        </button>
      </div>
